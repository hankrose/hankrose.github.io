...
### [我的博客在这里 &rarr;](http://hankrose.github.io)
...
huangxuan大神的博客仓库——`huxpro.github.io`，是经常修改的，而且还会有人乱提交代码，因此给大家做了一个稳定版的模板。大家可以直接fork模板——`huxblog-boilerplate`,要改的地方我都说明了。或者可以直接下载zip到本地自己去修改。
...
我的博客标题是 **“lingfengz Blog”** 但是我想要在搜索的时候显示 **“凌峰的博客 | Hux Blog”** ，这个就需要SEO Title来定义了。
